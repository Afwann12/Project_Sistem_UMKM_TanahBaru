...
function ensure_schema(PDO $pdo): void
{
    ...
    try {
        $pdo->exec("ALTER TABLE `umkm` MODIFY COLUMN `ktp_path` LONGTEXT NULL");
        $pdo->exec("ALTER TABLE `umkm` MODIFY COLUMN `nib_path` LONGTEXT NULL");
        $pdo->exec("ALTER TABLE `umkm` MODIFY COLUMN `lokasi_path` LONGTEXT NULL");
    } catch (Throwable $e) {}
