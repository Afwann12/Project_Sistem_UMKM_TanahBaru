                        ...
                        <div id="regStep3" class="space-y-3 hidden">
                            ...
                            <div class="space-y-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-2xl">
                                ...
                                <label class="flex items-center gap-3 px-4 py-2 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition">
                                    ...
                                    <input type="file" id="regFileKtp" required accept="image/*" onchange="handleRegisterFileSelect(event, 'ktp')" class="hidden">
                                </label>
                            </div>
                            ...
                            <div class="space-y-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-2xl">
                                ...
                                <label class="flex items-center gap-3 px-4 py-2 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition">
                                    ...
                                    <input type="file" id="regFileNib" required accept="image/*" onchange="handleRegisterFileSelect(event, 'nib')" class="hidden">
                                </label>
                            </div>
                            ...
                            <div class="space-y-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-2xl">
                                ...
                                <label class="flex items-center gap-3 px-4 py-2 bg-white border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition">
                                    ...
                                    <input type="file" id="regFileLokasi" required accept="image/*" onchange="handleRegisterFileSelect(event, 'lokasi')" class="hidden">
                                </label>
                            </div>
