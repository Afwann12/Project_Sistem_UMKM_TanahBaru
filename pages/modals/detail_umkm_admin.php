                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-2xl p-4 space-y-2.5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button onclick="openDocLightbox('admDetImgKtp')" class="text-[10px] text-brand-600 hover:underline font-bold"><i class="fa-solid fa-expand mr-1"></i> Perbesar Gambar</button>
                                </div>
                                <div class="relative h-44 w-full bg-slate-200/50 rounded-xl overflow-hidden border border-slate-200 cursor-pointer" onclick="openDocLightbox('admDetImgKtp')">
                                    <img id="admDetImgKtp" src="" alt="Scan KTP" class="w-full h-full object-cover">
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-2xl p-4 space-y-2.5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button onclick="openDocLightbox('admDetImgNib')" class="text-[10px] text-brand-600 hover:underline font-bold"><i class="fa-solid fa-expand mr-1"></i> Perbesar Gambar</button>
                                </div>
                                <div class="relative h-44 w-full bg-slate-200/50 rounded-xl overflow-hidden border border-slate-200 cursor-pointer" onclick="openDocLightbox('admDetImgNib')">
                                    <img id="admDetImgNib" src="" alt="Scan Berkas" class="w-full h-full object-cover">
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-50 border border-slate-150 rounded-2xl p-4 space-y-2.5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button onclick="openDocLightbox('admDetImgLokasi')" class="text-[10px] text-brand-600 hover:underline font-bold"><i class="fa-solid fa-expand mr-1"></i> Perbesar Gambar</button>
                                </div>
                                <div class="relative h-44 w-full bg-slate-200/50 rounded-xl overflow-hidden border border-slate-200 cursor-pointer" onclick="openDocLightbox('admDetImgLokasi')">
                                    <img id="admDetImgLokasi" src="" alt="Fisik Lokasi Toko" class="w-full h-full object-cover">
                                </div>
                            </div>
                        </div>
                    </div>
